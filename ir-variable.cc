...
//  }
  ...
  {
    if (pairs.empty ())
      throw ir_exception ("block-ir_def pair list unexpectedly empty.");
...
//        if (ir_def *d = blk.fetch_cached_def (*this))
//          return {*d, instr};
//      }
//    else if (ir_def *d = blk.fetch_proximate_def (*this, instr))
//      return {*d, instr};
//
//    // ir_def was not in the initial block
//    ir_def *d_latest = blk.join_pred_defs (*this);
//
//    if (d_latest == nullptr)
//      throw ir_exception ("variable not defined.");
//
//    // cache the latest ir_def
