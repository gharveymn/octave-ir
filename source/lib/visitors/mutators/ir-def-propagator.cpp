...
namespace gch
{
  ...
  template <>
  auto
  acceptor<ir_block, ir_descending_def_propagator>::
  ...
  template <>
  auto
  acceptor<ir_component_fork, ir_descending_def_propagator>::
  accept (visitor_reference v)
    -> result_type
  {
    return v.visit (static_cast<concrete_reference> (*this));
  ...
  template <>
  auto
  acceptor<ir_component_loop, ir_descending_def_propagator>::
  accept (visitor_reference v)
    -> result_type
  {
    return v.visit (static_cast<concrete_reference> (*this));
  ...
  template <>
  auto
  acceptor<ir_component_sequence, ir_descending_def_propagator>::
  accept (visitor_reference v)
    -> result_type
  {
    return v.visit (static_cast<concrete_reference> (*this));
  ...
  template <>
  auto
  acceptor<ir_function, ir_descending_def_propagator>::
  accept (visitor_reference v)
    -> result_type
  {
    return v.visit (static_cast<concrete_reference> (*this));
  ...
  template <>
  auto
  acceptor<ir_component_fork, ir_ascending_def_propagator>::
  accept (visitor_reference v)
    -> result_type
  {
    return v.visit (static_cast<concrete_reference> (*this));
  ...
  template <>
  auto
  acceptor<ir_component_loop, ir_ascending_def_propagator>::
  accept (visitor_reference v)
    -> result_type
  {
    return v.visit (static_cast<concrete_reference> (*this));
  ...
  template <>
  auto
  acceptor<ir_component_sequence, ir_ascending_def_propagator>::
  accept (visitor_reference v)
    -> result_type
  {
    return v.visit (static_cast<concrete_reference> (*this));
  ...
  template <>
  auto
  acceptor<ir_function, ir_ascending_def_propagator>::
  accept (visitor_reference v)
    -> result_type
  {
    return v.visit (static_cast<concrete_reference> (*this));
