...
#ifndef OCTAVE_IR_DYNAMIC_IR_IR_VISITOR_HPP
#define OCTAVE_IR_DYNAMIC_IR_IR_VISITOR_HPP
...
namespace gch
{
  ...
  protected:
    ...
    ~abstract_visitable           (void) override                 = default;
  };
...
#endif // OCTAVE_IR_DYNAMIC_IR_IR_VISITOR_HPP
