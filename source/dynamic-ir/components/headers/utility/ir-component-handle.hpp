...
#ifndef OCTAVE_IR_DYNAMIC_IR_IR_COMPONENT_HANDLE_HPP
#define OCTAVE_IR_DYNAMIC_IR_IR_COMPONENT_HANDLE_HPP
...
namespace gch
{
  ...
  using ir_component_storage = std::unique_ptr<ir_subcomponent>;
  ...
  class ir_component_handle
    : private detail::ir_component_handle_base<ir_component_storage, ir_subcomponent>
  {
    using base = detail::ir_component_handle_base<ir_component_storage, ir_subcomponent>;
  ...
  using ir_component_ptr  = ir_component_pointer<ir_subcomponent>;
  using ir_component_cptr = ir_component_pointer<const ir_subcomponent>;
...
#endif // OCTAVE_IR_DYNAMIC_IR_IR_COMPONENT_HANDLE_HPP
